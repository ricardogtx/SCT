...
Scenario: search clinic by name
	Given I have accessed the clinic page
...
Scenario: search clinic by estate
	Given I have accessed the clinic page
	When I fill in a string in the estate filter
	And I press the Buscar button
	Then the list shows only the clinics that contains that string in the estate
